...
/**
 * input_buf - buffer of the chained commands
 * @info: struct
 * @buf:  buffer
 * @len: the len var
 *
 * Return: reads the buffer out
 */
...
/**
 * get_input - gets the line of input without the new line
...
/**
 * read_buf - a fun. That reads any buffer
...
/**
 * _getline - gets the line from the std
